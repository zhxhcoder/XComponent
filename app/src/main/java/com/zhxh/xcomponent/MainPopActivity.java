...
public class MainPopActivity extends Activity implements
        OnClickListener {
    ...
    protected void findView() {
        listView = findViewById(R.id.supplier_list_lv);
        product = findViewById(R.id.supplier_list_product);
        sort = findViewById(R.id.supplier_list_sort);
        activity = findViewById(R.id.supplier_list_activity);
        productTv = findViewById(R.id.supplier_list_product_tv);
        sortTv = findViewById(R.id.supplier_list_sort_tv);
        activityTv = findViewById(R.id.supplier_list_activity_tv);
        titleTv = findViewById(R.id.supplier_list_title_tv);
        ...
        popListView.setOnItemClickListener(new OnItemClickListener() {
            public void onItemClick(AdapterView<?> arg0, View arg1, int pos,
                ...
                if (menuIndex == 0) {
                    ...
                    Toast.makeText(MainPopActivity.this, currentProduct, Toast.LENGTH_SHORT).show();
                } else if (menuIndex == 1) {
                    currentSort = menuData2.get(pos).get("name");
                    titleTv.setText(currentSort);
                    sortTv.setText(currentSort);
                    Toast.makeText(MainPopActivity.this, currentSort, Toast.LENGTH_SHORT).show();
                } else {
                    currentActivity = menuData3.get(pos).get("name");
                    titleTv.setText(currentActivity);
                    activityTv.setText(currentActivity);
                    Toast.makeText(MainPopActivity.this, currentActivity, Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
